...
export const LinesEffect = ({
    ...
    return (
        <div className={cn("sticky top-[30vh]", className)}>
            <h1 className="h1 mb-4 text-3xl md:text-7xl font-normal pb-10 text-center">
                Catenary helps
            ...
            <div className="w-full h-[890px] -top-60 md:-top-40 flex items-center justify-center bg-red-transparent absolute">
                <img src="/images/logo.svg" className="h-[70px]" style={{ transform: 'translateY(0px)' }} />
            </div>
            <svg
                width="1440"
                height="890"
